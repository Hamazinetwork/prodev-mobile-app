import PorpertyListing from '@components/PropertyListing';
    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView style={styles.listingContainer}>    
                <PorpertyListing listings={SAMPLE_DATA} />
                <View style={styles.paginationContainer}>
                    <TouchableHighlight style={styles.showMoreButtonText}>show more</TouchableHighlight>
                </View>
            </ScrollView>
        </View>
    );
